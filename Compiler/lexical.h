...
typedef enum{
	...
	GREATER=62, LESS_OR_EQUAL=147, GREATER_OR_EQUAL=148, EQUAL=61, DIFFERENT=149, BAR=47, INVERTED_BAR=92,
	ID=150, SIMPLE_QUOTATION_MARK=39, DOUBLE_QUOTATION_MARK=34, CONSTANT_NUMBER=151,
	CONSTANT_CHARACTER=152, CONSTANT_STRING=153, SPACE=32, TAB=9, FEED_LINE=10, LETTER_T_LOWER=116, LETTER_N_LOWER=110,
